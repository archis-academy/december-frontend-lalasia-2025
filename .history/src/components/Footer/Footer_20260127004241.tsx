...
const Footer: React.FC = () => {
  // Butona tıklandığında yönlendirme yapacak fonksiyon
  const handleNavigation = () => {
    // Kendi istediğin URL'yi buraya yazabilirsin
  ...
  return (
    <footer className="footer-wrapper">
      <div className="footer-container">
        ...
        {/* Alt Kısım: Marka ve Linkler */}
        <div className="footer-main">
          
          {/* Sol: Logo (İkon images/icons içinden çekiliyor) */}
